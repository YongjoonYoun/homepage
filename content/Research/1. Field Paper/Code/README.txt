This is the replication package for "The Economic Consequences of Hospital 
Admissions" by Harrison Yongjoon Youn (youn.62@osu.edu)

The package contains 2 subfolders:
...
3) Code: Includes codes from the raw data process to the result outputs. Instead of making a shall to run everything at once, 
	 I divided them in to separate files. Also, instead of using some system codes that often mask logic, I coded with intuitive 
	 logic so that anyone can replicate and follow the step. 

- 1. Data_Construction_KLoSA: This file import, correct some variable name errors given to harmonize 9 waves, and keep necessary variables. 
